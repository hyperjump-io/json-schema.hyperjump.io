...
`:`>
`;let y,m;for(m=r.length;m>0;--m){const A=r[m-1];if(A!==`
`&&A!=="	"&&A!==" ")break}let h=r.substring(m);const P=h.indexOf(`
`);P===-1?y="-":r===h||P!==h.length-1?(y="+",a&&a()):y="",h&&(r=r.slice(0,-h.length),h[h.length-1]===`
`&&(h=h.slice(0,-1)),h=h.replace(/\n+(?!\n|$)/g,`$&${l}`));let p=!1,d,v=-1;for(d=0;d<r.length;++d){const A=r[d];if(A===" ")p=!0;else if(A===`
`)v=d;else break}let O=r.substring(0,v<d?v+1:d);O&&(r=r.substring(O.length),O=O.replace(/\n+/g,`$&${l}`));let j=(f?"|":">")+(p?l?"2":"1":"")+y;if(e&&(j+=" "+o(e.replace(/ ?[\r\n]+/g," ")),s&&s()),f)return r=r.replace(/\n+/g,`$&${l}`),`${j}
${l}${O}${r}${h}`;r=r.replace(/\n+/g,`
...
${i}
${l}
`}};function Jr(e,{flow:t,indicator:r,next:n,offset:s,onError:a,startOnNewline:i}){let o=!1,c=i,l=i,f="",y="",m=!1,h=!1,P=!1,p=null,d=null,v=null,O=null,b=null;for(const A of e)switch(P&&(A.type!=="space"&&A.type!=="newline"&&A.type!=="comma"&&a(A.offset,"MISSING_CHAR","Tags and anchors must be separated from the next token by white space"),P=!1),A.type){case"space":!t&&c&&r!=="doc-start"&&A.source[0]==="	"&&a(A,"TAB_AS_INDENT","Tabs are not allowed as indentation"),l=!0;break;case"comment":{l||a(A,"MISSING_CHAR","Comments must be separated from other tokens by white space characters");const G=A.source.substring(1)||" ";f?f+=y+G:f=G,y="",c=!1;break}case"newline":c?f?f+=A.source:o=!0:y+=A.source,c=!0,m=!0,(p||d)&&(h=!0),l=!0;break;case"anchor":p&&a(A,"MULTIPLE_ANCHORS","A node can have at most one anchor"),A.source.endsWith(":")&&a(A.offset+A.source.length-1,"BAD_ALIAS","Anchor ending in : is ambiguous",!0),p=A,b===null&&(b=A.offset),c=!1,l=!1,P=!0;break;case"tag":{d&&a(A,"MULTIPLE_TAGS","A node can have at most one tag"),d=A,b===null&&(b=A.offset),c=!1,l=!1,P=!0;break}case r:(p||d)&&a(A,"BAD_PROP_ORDER",`Anchors and tags must be after the ${A.source} indicator`),O&&a(A,"UNEXPECTED_TOKEN",`Unexpected ${A.source} in ${t!=null?t:"collection"}`),O=A,c=!1,l=!1;break;case"comma":if(t){v&&a(A,"UNEXPECTED_TOKEN",`Unexpected , in ${t}`),v=A,c=!1,l=!1;break}default:a(A,"UNEXPECTED_TOKEN",`Unexpected ${A.type} token`),c=!1,l=!1}const j=e[e.length-1],S=j?j.offset+j.source.length:s;return P&&n&&n.type!=="space"&&n.type!=="newline"&&n.type!=="comma"&&(n.type!=="scalar"||n.source!=="")&&a(n.offset,"MISSING_CHAR","Tags and anchors must be separated from the next token by white space"),{comma:v,found:O,spaceBefore:o,comment:f,hasNewline:m,hasNewlineAfterProp:h,anchor:p,tag:d,end:S,start:b!=null?b:S}}function Ln(e){if(!e)return null;switch(e.type){case"alias":case"scalar":case"double-quoted-scalar":case"single-quoted-scalar":if(e.source.includes(`
`))return!0;if(e.end){for(const t of e.end)if(t.type==="newline")return!0}return!1;case"flow-collection":for(const t of e.items){for(const r of t.start)if(r.type==="newline")return!0;if(t.sep){for(const r of t.sep)if(r.type==="newline")return!0}if(Ln(t.key)||Ln(t.value))return!0}return!1;default:return!0}}function Mi(e,t,r){if((t==null?void 0:t.type)==="flow-collection"){const n=t.end[0];n.indent===e&&(n.source==="]"||n.source==="}")&&Ln(t)&&r(n,"BAD_INDENT","Flow end indicator should be more indented than parent",!0)}}function Pp(e,t,r){const{uniqueKeys:n}=e.options;if(n===!1)return!1;const s=typeof n=="function"?n:(a,i)=>a===i||be(a)&&be(i)&&a.value===i.value&&!(a.value==="<<"&&e.schema.merge);return t.some(a=>s(a.key,r))}const tl="All mapping items must start at the same column";function ny({composeNode:e,composeEmptyNode:t},r,n,s){var o;const a=new nt(r.schema);r.atRoot&&(r.atRoot=!1);let i=n.offset;for(const c of n.items){const{start:l,key:f,sep:y,value:m}=c,h=Jr(l,{indicator:"explicit-key-ind",next:f!=null?f:y==null?void 0:y[0],offset:i,onError:s,startOnNewline:!0}),P=!h.found;if(P){if(f&&(f.type==="block-seq"?s(i,"BLOCK_AS_IMPLICIT_KEY","A block sequence may not be used as an implicit map key"):"indent"in f&&f.indent!==n.indent&&s(i,"BAD_INDENT",tl)),!h.anchor&&!h.tag&&!y){h.comment&&(a.comment?a.comment+=`
`+h.comment:a.comment=h.comment);continue}(h.hasNewlineAfterProp||Ln(f))&&s(f!=null?f:l[l.length-1],"MULTILINE_IMPLICIT_KEY","Implicit keys need to be on a single line")}else((o=h.found)==null?void 0:o.indent)!==n.indent&&s(i,"BAD_INDENT",tl);const p=h.end,d=f?e(r,f,h,s):t(r,p,l,null,h,s);r.schema.compat&&Mi(n.indent,f,s),Pp(r,a.items,d)&&s(p,"DUPLICATE_KEY","Map keys must be unique");const v=Jr(y!=null?y:[],{indicator:"map-value-ind",next:m,offset:d.range[2],onError:s,startOnNewline:!f||f.type==="block-scalar"});if(i=v.end,v.found){P&&((m==null?void 0:m.type)==="block-map"&&!v.hasNewline&&s(i,"BLOCK_AS_IMPLICIT_KEY","Nested mappings are not allowed in compact mappings"),r.options.strict&&h.start<v.found.offset-1024&&s(d.range,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit block mapping key"));const O=m?e(r,m,v,s):t(r,i,y,null,v,s);r.schema.compat&&Mi(n.indent,m,s),i=O.range[2];const b=new Me(d,O);r.options.keepSourceTokens&&(b.srcToken=c),a.items.push(b)}else{P&&s(d.range,"MISSING_CHAR","Implicit map keys need to be followed by map values"),v.comment&&(d.comment?d.comment+=`
`+v.comment:d.comment=v.comment);const O=new Me(d);r.options.keepSourceTokens&&(O.srcToken=c),a.items.push(O)}}return a.range=[n.offset,i,i],a}function sy({composeNode:e,composeEmptyNode:t},r,n,s){const a=new pr(r.schema);r.atRoot&&(r.atRoot=!1);let i=n.offset;for(const{start:o,value:c}of n.items){const l=Jr(o,{indicator:"seq-item-ind",next:c,offset:i,onError:s,startOnNewline:!0});if(i=l.end,!l.found)if(l.anchor||l.tag||c)c&&c.type==="block-seq"?s(i,"BAD_INDENT","All sequence items must start at the same column"):s(i,"MISSING_CHAR","Sequence item without - indicator");else{l.comment&&(a.comment=l.comment);continue}const f=c?e(r,c,l,s):t(r,i,o,null,l,s);r.schema.compat&&Mi(n.indent,c,s),i=f.range[2],a.items.push(f)}return a.range=[n.offset,i,i],a}function Xn(e,t,r,n){let s="";if(e){let a=!1,i="";for(const o of e){const{source:c,type:l}=o;switch(l){case"space":a=!0;break;case"comment":{r&&!a&&n(o,"MISSING_CHAR","Comments must be separated from other tokens by white space characters");const f=c.substring(1)||" ";s?s+=i+f:s=f,i="";break}case"newline":s&&(i+=c),a=!0;break;default:n(o,"UNEXPECTED_TOKEN",`Unexpected ${l} at node end`)}t+=c.length}}return{comment:s,offset:t}}const Ka="Block collections are not allowed within flow collections",Ja=e=>e&&(e.type==="block-map"||e.type==="block-seq");function ay({composeNode:e,composeEmptyNode:t},r,n,s){var P;const a=n.start.source==="{",i=a?"flow map":"flow sequence",o=a?new nt(r.schema):new pr(r.schema);o.flow=!0;const c=r.atRoot;c&&(r.atRoot=!1);let l=n.offset+n.start.source.length;for(let p=0;p<n.items.length;++p){const d=n.items[p],{start:v,key:O,sep:b,value:j}=d,S=Jr(v,{flow:i,indicator:"explicit-key-ind",next:O!=null?O:b==null?void 0:b[0],offset:l,onError:s,startOnNewline:!1});if(!S.found){if(!S.anchor&&!S.tag&&!b&&!j){p===0&&S.comma?s(S.comma,"UNEXPECTED_TOKEN",`Unexpected , in ${i}`):p<n.items.length-1&&s(S.start,"UNEXPECTED_TOKEN",`Unexpected empty item in ${i}`),S.comment&&(o.comment?o.comment+=`
`+S.comment:o.comment=S.comment),l=S.end;continue}!a&&r.options.strict&&Ln(O)&&s(O,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line")}if(p===0)S.comma&&s(S.comma,"UNEXPECTED_TOKEN",`Unexpected , in ${i}`);else if(S.comma||s(S.start,"MISSING_CHAR",`Missing , between ${i} items`),S.comment){let A="";e:for(const G of v)switch(G.type){case"comma":case"space":break;case"comment":A=G.source.substring(1);break e;default:break e}if(A){let G=o.items[o.items.length-1];Ee(G)&&(G=(P=G.value)!=null?P:G.key),G.comment?G.comment+=`
...
`+re.comment:G.comment=re.comment);const C=new Me(G,I);if(r.options.keepSourceTokens&&(C.srcToken=d),a){const N=o;Pp(r,N.items,G)&&s(A,"DUPLICATE_KEY","Map keys must be unique"),N.items.push(C)}else{const N=new nt(r.schema);N.flow=!0,N.items.push(C),o.items.push(N)}l=I?I.range[2]:re.end}}const f=a?"}":"]",[y,...m]=n.end;let h=l;if(y&&y.source===f)h=y.offset+y.source.length;else{const p=i[0].toUpperCase()+i.substring(1),d=c?`${p} must end with a ${f}`:`${p} in block collection must be sufficiently indented and end with a ${f}`;s(l,c?"MISSING_CHAR":"BAD_INDENT",d),y&&y.source.length!==1&&m.unshift(y)}if(m.length>0){const p=Xn(m,h,r.options.strict,s);p.comment&&(o.comment?o.comment+=`
`+p.comment:o.comment=p.comment),o.range=[n.offset,h,p.offset]}else o.range=[n.offset,h,h];return o}function iy(e,t,r,n,s){let a;switch(r.type){case"block-map":{a=ny(e,t,r,s);break}case"block-seq":{a=sy(e,t,r,s);break}case"flow-collection":{a=ay(e,t,r,s);break}}if(!n)return a;const i=t.directives.tagName(n.source,m=>s(n,"TAG_RESOLVE_FAILED",m));if(!i)return a;const o=a.constructor;if(i==="!"||i===o.tagName)return a.tag=o.tagName,a;const c=ur(a)?"map":"seq";let l=t.schema.tags.find(m=>m.collection===c&&m.tag===i);if(!l){const m=t.schema.knownTags[i];if(m&&m.collection===c)t.schema.tags.push(Object.assign({},m,{default:!1})),l=m;else return s(n,"TAG_RESOLVE_FAILED",`Unresolved tag: ${i}`,!0),a.tag=i,a}const f=l.resolve(a,m=>s(n,"TAG_RESOLVE_FAILED",m),t.options),y=_e(f)?f:new ee(f);return y.range=a.range,y.tag=i,l!=null&&l.format&&(y.format=l.format),y}function kp(e,t,r){const n=e.offset,s=oy(e,t,r);if(!s)return{value:"",type:null,comment:"",range:[n,n,n]};const a=s.mode===">"?ee.BLOCK_FOLDED:ee.BLOCK_LITERAL,i=e.source?cy(e.source):[];let o=i.length;for(let p=i.length-1;p>=0;--p){const d=i[p][1];if(d===""||d==="\r")o=p;else break}if(o===0){const p=s.chomp==="+"&&i.length>0?`
`.repeat(Math.max(1,i.length-1)):"";let d=n+s.length;return e.source&&(d+=e.source.length),{value:p,type:a,comment:s.comment,range:[n,d,d]}}let c=e.indent+s.indent,l=e.offset+s.length,f=0;for(let p=0;p<o;++p){const[d,v]=i[p];if(v===""||v==="\r")s.indent===0&&d.length>c&&(c=d.length);else{if(d.length<c){const O="Block scalars with more-indented leading empty lines must use an explicit indentation indicator";r(l+d.length,"MISSING_CHAR",O)}s.indent===0&&(c=d.length),f=p;break}l+=d.length+v.length+1}for(let p=i.length-1;p>=o;--p)i[p][0].length>c&&(o=p+1);let y="",m="",h=!1;for(let p=0;p<f;++p)y+=i[p][0].slice(c)+`
`;for(let p=f;p<o;++p){let[d,v]=i[p];l+=d.length+v.length+1;const O=v[v.length-1]==="\r";if(O&&(v=v.slice(0,-1)),v&&d.length<c){const j=`Block scalar lines must not be less indented than their ${s.indent?"explicit indentation indicator":"first line"}`;r(l-v.length-(O?2:1),"BAD_INDENT",j),d=""}a===ee.BLOCK_LITERAL?(y+=m+d.slice(c)+v,m=`
`):d.length>c||v[0]==="	"?(m===" "?m=`
`:!h&&m===`
`&&(m=`
...
`?y+=`
`:m=`
`:(y+=m+v,m=" ",h=!1)}switch(s.chomp){case"-":break;case"+":for(let p=o;p<i.length;++p)y+=`
`+i[p][0].slice(c);y[y.length-1]!==`
`&&(y+=`
`);break;default:y+=`
`}const P=n+s.length+e.source.length;return{value:y,type:a,comment:s.comment,range:[n,P,P]}}function oy({offset:e,props:t},r,n){if(t[0].type!=="block-scalar-header")return n(t[0],"IMPOSSIBLE","Block scalar header not found"),null;const{source:s}=t[0],a=s[0];let i=0,o="",c=-1;for(let m=1;m<s.length;++m){const h=s[m];if(!o&&(h==="-"||h==="+"))o=h;else{const P=Number(h);!i&&P?i=P:c===-1&&(c=e+m)}}c!==-1&&n(c,"UNEXPECTED_TOKEN",`Block scalar header includes extra characters: ${s}`);let l=!1,f="",y=s.length;for(let m=1;m<t.length;++m){const h=t[m];switch(h.type){case"space":l=!0;case"newline":y+=h.source.length;break;case"comment":r&&!l&&n(h,"MISSING_CHAR","Comments must be separated from other tokens by white space characters"),y+=h.source.length,f=h.source.substring(1);break;case"error":n(h,"UNEXPECTED_TOKEN",h.message),y+=h.source.length;break;default:{const P=`Unexpected token in block scalar header: ${h.type}`;n(h,"UNEXPECTED_TOKEN",P);const p=h.source;p&&typeof p=="string"&&(y+=p.length)}}}return{mode:a,indent:i,chomp:o,comment:f,length:y}}function cy(e){const t=e.split(/\n( *)/),r=t[0],n=r.match(/^( *)/),a=[n!=null&&n[1]?[n[1],r.slice(n[1].length)]:["",r]];for(let i=1;i<t.length;i+=2)a.push([t[i],t[i+1]]);return a}function jp(e,t,r){const{offset:n,type:s,source:a,end:i}=e;let o,c;const l=(m,h,P)=>r(n+m,h,P);switch(s){case"scalar":o=ee.PLAIN,c=ly(a,l);break;case"single-quoted-scalar":o=ee.QUOTE_SINGLE,c=fy(a,l);break;case"double-quoted-scalar":o=ee.QUOTE_DOUBLE,c=uy(a,l);break;default:return r(e,"UNEXPECTED_TOKEN",`Expected a flow scalar value, but found: ${s}`),{value:"",type:null,comment:"",range:[n,n+a.length,n+a.length]}}const f=n+a.length,y=Xn(i,f,t,r);return{value:c,type:o,comment:y.comment,range:[n,f,y.offset]}}function ly(e,t){let r="";switch(e[0]){case"	":r="a tab character";break;case",":r="flow indicator character ,";break;case"%":r="directive indicator character %";break;case"|":case">":{r=`block scalar indicator ${e[0]}`;break}case"@":case"`":{r=`reserved character ${e[0]}`;break}}return r&&t(0,"BAD_SCALAR_START",`Plain value cannot start with ${r}`),Ap(e)}function fy(e,t){return(e[e.length-1]!=="'"||e.length===1)&&t(e.length,"MISSING_CHAR","Missing closing 'quote"),Ap(e.slice(1,-1)).replace(/''/g,"'")}function Ap(e){var c;let t,r;try{t=new RegExp(`(.*?)(?<![ 	])[ 	]*\r?
`,"sy"),r=new RegExp(`[ 	]*(.*?)(?:(?<![ 	])[ 	]*)?\r?
